...
public interface DormitoryRepository extends JpaRepository<Dormitory, Long> {
    ...
    List<Dormitory> findBySchool_IdAndBuildingAndFloorOrderByRoomNumberAscBedNumberAsc(Long schoolId, String building,
            Integer floor);
    ...
    // 특정 호실의 모든 침대 + 현재 학기 배정 학생 Fetch Join 조회 (schoolId 필터)
    ...
    // 학생 이름으로 해당 학생이 배정된 건물 목록 검색 (현재 학기, schoolId 필터)
    ...
    void updateBuildingName(@Param("oldName") String oldName, @Param("newName") String newName,
            @Param("schoolId") Long schoolId);
}
