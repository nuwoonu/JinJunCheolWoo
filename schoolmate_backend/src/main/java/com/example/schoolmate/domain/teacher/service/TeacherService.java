package com.example.schoolmate.domain.teacher.service;
...
import com.example.schoolmate.domain.teacher.dto.ClassStudentDTO;
import com.example.schoolmate.domain.grade.dto.GradeInputDTO;
import com.example.schoolmate.domain.teacher.dto.TeacherResponseDTO;
import com.example.schoolmate.domain.teacher.dto.TeacherUpdateDTO;
...
public class TeacherService {
    ...
    public void createTeacher(TeacherDTO.CreateRequest request) {
        ...
        if (request.getSubject() != null && !request.getSubject().isBlank()) {
            Subject subject = findSubjectByCode(request.getSubject())
    ...
    public TeacherResponseDTO updateTeacher(Long id, TeacherUpdateDTO updateDTO) {
        ...
        if (updateDTO.getSubject() != null) {
            Subject subject = findSubjectByCode(updateDTO.getSubject())
    ...
    /** 학교 범위 내 과목 코드로 Subject 조회 (schoolId가 없으면 전체에서 첫 번째 매칭) */
    private java.util.Optional<com.example.schoolmate.domain.grade.entity.Subject> findSubjectByCode(String code) {
        Long schoolId = SchoolContextHolder.getSchoolId();
