package com.example.schoolmate.domain.schedule.controller;
...
import com.example.schoolmate.domain.timetable.entity.constant.DayOfWeek;
import com.example.schoolmate.domain.schedule.dto.TeacherScheduleDTO;
import com.example.schoolmate.domain.schedule.service.TeacherScheduleService;
import com.example.schoolmate.domain.grade.service.SubjectService;
...
public class TeacherScheduleRestController {
    ...
    /**
     * [woo] 단일 일정 조회 (React ScheduleEdit 페이지용)
     */
    @GetMapping("/{id}")
    public ResponseEntity<TeacherScheduleDTO.Response> getSchedule(
