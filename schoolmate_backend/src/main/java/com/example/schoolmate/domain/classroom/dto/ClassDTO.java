package com.example.schoolmate.domain.classroom.dto;
    ...
    public static class DetailResponse {
        ...
        public static DetailResponse from(Classroom classroom, int studentCount) {
            ...
            if (teacher != null && teacher.getInfoForSchool(TeacherInfo.class,
                    com.example.schoolmate.global.config.school.SchoolContextHolder.getSchoolId()) != null) {
                TeacherInfo ti = teacher.getInfoForSchool(TeacherInfo.class,
                    com.example.schoolmate.global.config.school.SchoolContextHolder.getSchoolId());
    ...
    public static class HistoryResponse {
        ...
        public static HistoryResponse from(SchoolmateLog history) {
            return HistoryResponse.builder()
                    ...
                    .createdBy(history.getActorName())
                    .createdAt(history.getCreateDate())
                    .build();
        }
    }
}