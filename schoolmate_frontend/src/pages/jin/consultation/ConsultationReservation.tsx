...
export default function ConsultationReservation() {
  ...
  return (
    <DashboardLayout>
      {/* 헤더 */}
      <div
        className="d-flex align-items-center gap-12 mb-24 p-20 rounded-16"
        style={{
                ...
                <div key={s.key} className="col-6 col-md-3">
                  <div
                    ...
                    style={{
                      borderRadius: 12,
                      cursor: "pointer",
                      outline: listFilter === s.key ? `2px solid ${s.color}` : "none",
                    }}
                  ...
                  >
                    <div className="card-body p-16 d-flex align-items-center gap-12">
                      ...
                      <div>
                        ...
                        <div className="fw-bold text-lg">{count}</div>
                      </div>
                    </div>
                  </div>
                </div>
