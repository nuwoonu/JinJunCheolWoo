    ...
    <DashboardLayout>
      <div className="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        ...
        <ul className="d-flex align-items-center gap-2">
          ...
          <li>-</li>
          <li className="fw-medium"><Link to="/teacher/schedule">수업 일정</Link></li>
          <li>-</li>
          <li className="fw-medium">일정 수정</li>
        </ul>
      </div>
            ...
            <div className="row gy-16">
              ...
              <div className="col-md-6">
                ...
                <input type="text" className="form-control" placeholder="예: 수학"
                  value={form.subjectName} onChange={set('subjectName')} required />
              </div>
              <div className="col-md-6">
              ...
              {form.repeatType === 'ONCE' && (
                <div className="col-12">
                  ...
                  <input type="date" className="form-control"
                    value={form.specificDate} onChange={set('specificDate')} />
                </div>
              )}
              <div className="col-12">
                <label className="form-label fw-semibold text-sm">메모</label>
                <textarea className="form-control" rows={3} placeholder="메모 (선택)"
                  value={form.memo} onChange={set('memo')} />
              </div>
            </div>

            <div className="d-flex gap-8 mt-24">
              <button type="button" className="btn btn-outline-neutral-300 radius-8" onClick={() => navigate('/teacher/schedule')}>
                취소
              </button>
