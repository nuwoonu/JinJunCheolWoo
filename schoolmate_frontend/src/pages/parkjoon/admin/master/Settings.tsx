...
export default function Settings() {
  ...
  return (
    <AdminLayout>
      <h2 className="mb-4">시스템 설정</h2>

      <form onSubmit={handleSubmit} className="card shadow-sm mb-4">
        <div className="card-header bg-white py-3">
          <h5 className="mb-0 fw-bold">학사 기준 정보</h5>
        </div>
        <div className="card-body p-5">
          <div className="row g-4">
            <div className="col-md-6">
              <label className="form-label fw-bold">현재 학년도</label>
            ...
            <div className="col-md-6">
              <label className="form-label fw-bold">현재 학기</label>
