...
export default function TeacherList() {
  ...
  const {
    ...
    triggerUpload,
    handleFileChange,
  } = useCsvUpload("/teachers/import-csv", () => load(0));
      ...
      {loading && (
        ...
        >
          <div style={{ textAlign: "center" }}>
            ...
            />
            <h5 style={{ color: "#fff", marginTop: 16 }}>
              교사 데이터를 등록 중입니다...
            </h5>
          </div>
        </div>
                    ...
                    {(() => {
                      ...
                      return (
                        <span
                          style={{
                            ...badgeBase,
                            ...getStatusBadgeStyle(t.statusName),
                          }}
                        >
                          {cfg.label}
                        </span>
                    ...
                    {t.roleRequestStatus ? (
                      ...
                      >
                        <span
                          style={{
                            ...badgeBase,
                            ...getRoleRequestBadgeStyle(t.roleRequestStatus),
                          }}
                        >
                          {
                            (
                              ROLE_REQUEST_STATUS[t.roleRequestStatus] ??
