...
export const ADMIN_GRANTS = {
  ...
  /** 기숙사 관리 */
  DORMITORY: [...SCHOOL_LEVEL, GRANTED_ROLE.DORMITORY_MANAGER],

  /** 과목 관리: SCHOOL_ADMIN 이상 */
  SUBJECTS:  [...SCHOOL_LEVEL],

  /** 학기 설정: SCHOOL_ADMIN 이상 */
  SETTINGS:  [...SCHOOL_LEVEL],

  /** 기준 정보 (교과목·시스템 설정): SUPER_ADMIN 전용 (하위 호환용, 직접 사용 지양) */
