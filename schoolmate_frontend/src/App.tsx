...
function App() {
  return (
    <Routes>
      ...
      {/* [cheol] 학생 본인 정보 */}
      <Route path="/student/myinfo" element={
      ...
      <Route path="/teacher/myclass" element={
        <PrivateRoute allowedRoles={['TEACHER', 'ADMIN']}>
          <TeacherMyClass />
        </PrivateRoute>
      } />
      <Route path="/teacher/myclass/students" element={
        <PrivateRoute allowedRoles={['TEACHER', 'ADMIN']}>
      ...
      {/* [woo] 학부모 목록 (교사/관리자용) */}
      <Route path="/teacher/parent/list" element={
        <PrivateRoute allowedRoles={['TEACHER', 'ADMIN']}>
          <ParentList />
        </PrivateRoute>
      } />
      ...
      <Route path="/board/grade/:grade" element={
        <PrivateRoute allowedRoles={['STUDENT', 'TEACHER', 'ADMIN', 'PARENT']}>
          <GradeBoard />
        </PrivateRoute>
      } />
      <Route path="/board/grade/:grade/:id" element={
        <PrivateRoute allowedRoles={['STUDENT', 'TEACHER', 'ADMIN', 'PARENT']}>
          <GradeBoardDetail />
        </PrivateRoute>
      } />
      ...
      {/* [woo] 게시판 */}
      <Route path="/board/school-notice" element={
        <PrivateRoute allowedRoles={['STUDENT', 'TEACHER', 'ADMIN', 'PARENT']}>
          <SchoolNotice />
        </PrivateRoute>
      } />
      <Route path="/board/school-notice/:id" element={
        <PrivateRoute allowedRoles={['STUDENT', 'TEACHER', 'ADMIN', 'PARENT']}>
          <SchoolNoticeDetail />
        </PrivateRoute>
      } />
      {/* [woo] 학부모 공지 */}
      <Route path="/board/parent-notice" element={
        <PrivateRoute allowedRoles={['PARENT', 'TEACHER', 'ADMIN']}>
          <ParentNotice />
        </PrivateRoute>
      } />
      <Route path="/board/parent-notice/:id" element={
        <PrivateRoute allowedRoles={['PARENT', 'TEACHER', 'ADMIN']}>
          <ParentNoticeDetail />
        </PrivateRoute>
      } />
      {/* [woo] 학부모 자유게시판 */}
      <Route path="/board/parent" element={
        <PrivateRoute allowedRoles={['PARENT', 'TEACHER', 'ADMIN']}>
          <ParentBoard />
        </PrivateRoute>
      } />
      <Route path="/board/parent/:id" element={
        <PrivateRoute allowedRoles={['PARENT', 'TEACHER', 'ADMIN']}>
          <ParentBoardDetail />
        </PrivateRoute>
      } />
      ...
      <Route path="/parent/children/status" element={
        <PrivateRoute allowedRoles={['PARENT', 'ADMIN']}>
      ...
      {/* [woo] 교직원 게시판 */}
      <Route path="/board/teacher" element={
        <PrivateRoute allowedRoles={['TEACHER', 'ADMIN']}>
          <TeacherBoard />
        </PrivateRoute>
      } />
      <Route path="/board/teacher/:id" element={
        <PrivateRoute allowedRoles={['TEACHER', 'ADMIN']}>
          <TeacherBoardDetail />
        </PrivateRoute>
      } />
      ...
      <Route path="/teacher/schedule/add" element={
        <PrivateRoute allowedRoles={['TEACHER', 'ADMIN']}>
          <TeacherScheduleAdd />
        </PrivateRoute>
      } />
      <Route path="/teacher/schedule/edit/:id" element={
        <PrivateRoute allowedRoles={['TEACHER', 'ADMIN']}>
          <TeacherScheduleEdit />
        </PrivateRoute>
      } />
      ...
      {/* [soojin] 상담 신청 예약 (캘린더) */}
      <Route path="/consultation/reservation" element={
      ...
      <Route path="/school/gallery" element={
        <PrivateRoute allowedRoles={['STUDENT', 'TEACHER', 'ADMIN', 'PARENT']}>
          <SchoolGallery />
        </PrivateRoute>
      } />
