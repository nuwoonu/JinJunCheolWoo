...
function SchoolSelectGuard() {
  ...
  const firstGrant = !isSuperAdmin
    ? user?.grants?.find((g) => g.schoolId)
    : undefined;
...
function App() {
  return (
    <Routes>
      ...
      {/* 회원가입 - 학교 선택 (교사/학생) */}
      <Route
        path="/register/school-select"
        element={<RegisterSchoolSelect />}
      />
      ...
      <Route
        ...
        element={
          <PrivateRoute
            allowedRoles={["ADMIN"]}
            requiredGrants={ADMIN_GRANTS.DASHBOARD}
          >
            <JoonAdminMain />
          </PrivateRoute>
        }
      ...
      <Route
        ...
        element={
          <PrivateRoute
            allowedRoles={["ADMIN"]}
            requiredGrants={ADMIN_GRANTS.STUDENTS}
          >
            <JoonStudentList />
          </PrivateRoute>
        }
      ...
      <Route
        ...
        element={
          <PrivateRoute
            allowedRoles={["ADMIN"]}
            requiredGrants={ADMIN_GRANTS.TEACHERS}
          >
            <JoonTeacherList />
          </PrivateRoute>
        }
      ...
      <Route
        ...
        element={
          <PrivateRoute
            allowedRoles={["ADMIN"]}
            requiredGrants={ADMIN_GRANTS.STAFFS}
          >
            <JoonStaffList />
          </PrivateRoute>
        }
      ...
      <Route
        ...
        element={
          <PrivateRoute
            allowedRoles={["ADMIN"]}
            requiredGrants={ADMIN_GRANTS.CLASSES}
          >
            <JoonClassList />
          </PrivateRoute>
        }
      ...
      <Route
        ...
        element={
          <PrivateRoute
            allowedRoles={["ADMIN"]}
            requiredGrants={ADMIN_GRANTS.NOTICES}
          >
            <JoonNoticeList />
          </PrivateRoute>
        }
      ...
      <Route
        ...
        element={
          <PrivateRoute
            allowedRoles={["ADMIN"]}
            requiredGrants={ADMIN_GRANTS.FACILITIES}
          >
            <JoonRooms />
          </PrivateRoute>
        }
      ...
      <Route
        ...
        element={
          <PrivateRoute
            allowedRoles={["ADMIN"]}
            requiredGrants={ADMIN_GRANTS.ASSETS}
          >
            <JoonAssets />
          </PrivateRoute>
        }
      ...
      <Route
        ...
        element={
          <PrivateRoute
            ...
            requiredGrants={ADMIN_GRANTS.DORMITORY}
          >
            <DormitoryAdminRoot />
          </PrivateRoute>
        }
      ...
      <Route
        ...
        element={
          <PrivateRoute
            allowedRoles={["ADMIN"]}
            requiredGrants={ADMIN_GRANTS.SCHEDULE}
          >
            <JoonSchedule />
          </PrivateRoute>
        }
      ...
      <Route
        ...
        element={
          <PrivateRoute
            allowedRoles={["ADMIN"]}
            requiredGrants={ADMIN_GRANTS.SUBJECTS}
          >
            <JoonSubjects />
          </PrivateRoute>
        }
      ...
      <Route
        ...
        element={
          <PrivateRoute
            allowedRoles={["ADMIN"]}
            requiredGrants={ADMIN_GRANTS.SETTINGS}
          >
            <JoonSettings />
          </PrivateRoute>
        }
      ...
      <Route
        ...
        element={
          <PrivateRoute
            allowedRoles={["ADMIN"]}
            requiredGrants={ADMIN_GRANTS.AUDIT}
          >
            <JoonAccessLogs />
          </PrivateRoute>
        }
