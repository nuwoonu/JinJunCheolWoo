          ...
          <div className="register-body">
            <div className="register-form" style={{ maxWidth: 600 }}>
              ...
              <div className="text-center" style={{ marginBottom: 70 }}>
                <h2 className="register-title">{source === "email" ? "학교 선택" : "학교 선택"}</h2>
              ...
              <form onSubmit={handleSearch} className="mb-3">
                <div className="row g-2 align-items-end">
                  <div className="col-3">
                    <select className="form-select" value={schoolKind} onChange={(e) => setSchoolKind(e.target.value)}>
                      {SCHOOL_KINDS.map((k) => (
                  ...
                  <div className="col-3">
                    ...
                    >
                      {loading ? (
                        ...
                        <>
                          <i className="ri-search-line me-1"></i>검색
                        </>
                      )}
                    </button>
                  </div>
                  ...
                  {schools.length === 0 ? (
                    ...
                    <div style={{ border: "1px solid #e5e7eb", borderRadius: 10, overflow: "hidden" }}>
                      {schools.map((school, idx) => {
                        const isDuplicate =
                          source === "hub" &&
                          existingContexts.some((c) => c.roleType === role && c.schoolId === school.id);
                        return (
                          <div
                            key={school.id}
                            style={{
                          ...
                          >
                            <div>
                              <div
                                style={{ fontWeight: 600, fontSize: 14, color: isDuplicate ? "#9ca3af" : "#1a1a1a" }}
                              >
                                {school.name}
                              </div>
