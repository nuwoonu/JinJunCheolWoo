      ...
      >
        ...
        >
          ...
          >
            ...
            <li>기숙사: 각 학교 1~3동</li>
            <li>
              분반(CourseSection): 학급별 교과목 담당 교사 배정
            </li>
            <li>
              과제: 핵심 과목(국·수·과·영·사) 2건씩, 학생 제출·채점 포함
            </li>
            <li>
              퀴즈: 국어·수학·과학·영어 객관식+단답형 퀴즈, 학생 응시 결과
            </li>
            <li>성적: 학생별 중간·기말고사 전 과목 성적 등록</li>
            <li>도서관: 도서 20권, 대출 이력·리뷰 포함</li>
            <li>기숙사 입주: 학생 40% 기숙사 배정</li>
            <li>
              생활기록부: 행동특성·수상이력·봉사활동·진로희망·체험활동·독서록
            </li>
            <li>상담 예약: 학부모 상담 예약 6건 (대기·확정·완료 상태)</li>
            <li>학급 게시판: 교사·학생 게시글 및 댓글</li>
            <li>
