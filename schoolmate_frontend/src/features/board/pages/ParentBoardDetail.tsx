...
export default function ParentBoardDetail() {
  ...
  if (loading) {
    return <DashboardLayout><div style={{ textAlign: 'center', paddingTop: 48, paddingBottom: 48, color: '#94a3b8' }}>불러오는 중...</div></DashboardLayout>
  }
      ...
      <div className="card" style={{ maxWidth: 860, margin: '0 auto', borderRadius: 12, overflow: 'hidden', border: '1px solid #e2e8f0' }}>
        ...
        <div className="card-header" style={{ padding: '20px 24px', borderBottom: 'none' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 10 }}>
            <span style={{ fontSize: 12, fontWeight: 500, padding: '2px 8px', borderRadius: 4, background: '#fef9c3', color: '#ca8a04', display: 'inline-block' }}>학부모 게시판</span>
        ...
        <div style={{ padding: '16px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 8 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
            ...
            <Link to="/board/parent" style={{ padding: '5px 10px', background: '#fff', border: '1px solid #d1d5db', borderRadius: 6, fontSize: 13, color: '#374151', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 6 }}>
