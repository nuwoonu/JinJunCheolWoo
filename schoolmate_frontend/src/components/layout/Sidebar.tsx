...
=======
          {has("ADMIN") && (
            <li>
              <Link to="/parkjoon/admin/dashboard">
...
=======
                <li>
                  <Link to="/parkjoon/admin/students">
                    <i className="ri-circle-fill circle-icon w-auto" /> 학생 관리
                  </Link>
                </li>
                <li>
                  <Link to="/parkjoon/admin/teachers">
                    <i className="ri-circle-fill circle-icon w-auto" /> 교사 관리
                  </Link>
                </li>
                <li>
                  <Link to="/parkjoon/admin/parents">
                    <i className="ri-circle-fill circle-icon w-auto" /> 학부모 관리
                  </Link>
                </li>
                <li>
                  <Link to="/parkjoon/admin/staffs">
...
=======
                <li>
                  <Link to="/parkjoon/admin/classes">
                    <i className="ri-circle-fill circle-icon w-auto" /> 학급 목록
                  </Link>
                </li>
                <li>
                  <Link to="/parkjoon/admin/classes/create">
          ...
          {has("ADMIN") && (
            <li>
              <Link to="/parkjoon/admin/notices">
                <i className="ri-megaphone-line" />
                <span>공지사항 관리</span>
              </Link>
            </li>
...
=======
                <li>
                  <Link to="/parkjoon/admin/facilities">
                    <i className="ri-circle-fill circle-icon w-auto" /> 시설 관리
                  </Link>
                </li>
                <li>
                  <Link to="/parkjoon/admin/assets">
...
=======
                <li>
                  <Link to="/parkjoon/admin/master/schedule">
                    <i className="ri-circle-fill circle-icon w-auto" /> 학사 일정
                  </Link>
                </li>
                <li>
                  <Link to="/parkjoon/admin/master/subjects">
                    <i className="ri-circle-fill circle-icon w-auto" /> 교과목
                  </Link>
                </li>
                <li>
                  <Link to="/parkjoon/admin/master/settings">
