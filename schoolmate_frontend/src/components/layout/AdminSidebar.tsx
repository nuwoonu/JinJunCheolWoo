            ...
            >
              <span className="d-flex align-items-start gap-10">
                ...
                <span className="profile-dropdown__contents">
                  ...
                  <span className="text-secondary-light text-sm mb-0 d-block">관리자</span>
                </span>
              </span>
      ...
      <div className="sidebar-menu-area">
        <ul className="sidebar-menu" id="sidebar-menu">
          ...
          <li className={dc(open.adminAudit)}>
            ...
            <ul className="sidebar-submenu">
              <li><Link to={ADMIN_ROUTES.AUDIT.ACCESS}><i className="ri-circle-fill circle-icon w-auto" /> 접근 로그</Link></li>
              <li><Link to={ADMIN_ROUTES.AUDIT.CHANGES}><i className="ri-circle-fill circle-icon w-auto" /> 변경 로그</Link></li>
            </ul>
          </li>
