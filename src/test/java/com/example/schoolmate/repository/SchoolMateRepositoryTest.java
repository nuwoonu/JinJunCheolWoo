...
// import
// com.example.schoolmate.common.entity.info.assignment.StudentAssignment;
...
// StudentInfo student =
// studentInfoRepository.findAll().stream().findFirst().orElse(null);
...
// students.forEach(s -> {
// System.out.println("---");
// System.out.println("이름: " + (s.getUser() != null ? s.getUser().getName() :
// "N/A"));
...
// teachers.forEach(t -> {
// System.out.println("---");
// System.out.println("이름: " + (t.getUser() != null ? t.getUser().getName() :
// "N/A"));
...
// System.out.println(" - 2026년: " + (oldAssignment != null ?
// oldAssignment.getGrade() + "학년" : "없음"));
...
// TeacherInfo teacher =
// teacherInfoRepository.findAll().stream().findFirst().orElse(null);
