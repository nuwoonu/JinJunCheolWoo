!(function () {
              ...
              setTimeout(() => {
                ...
                e.forEach((e) => {
                  ...
                  (o.pending = o.pending.filter((e) => {
                    ...
                    o.pending.length !== s &&
                      (n || S([t], e.id),
                      e.callback(o.loaded.slice(0), o.missing.slice(0), o.pending.slice(0), e.abort));
                });
              }));
          })(t);
      }));
  ...
  const St = {
    prepare: (t, e, n) => {
      ...
      return (
        n.forEach((n, a) => {
          (c += n.length + 1),
            c >= r && a > 0 && (i.push(s), (s = { type: o, provider: t, prefix: e, icons: [] }), (c = n.length)),
            s.icons.push(n);
        }),
        i.push(s),
        i
  ...
  function Rt(t, e) {
    ...
    n || ((n = document.createElement("style")), n.setAttribute(Mt, Mt), t.appendChild(n)),
      (n.textContent =
        ":host{display:inline-block;vertical-align:" + (e ? "-0.125em" : "0") + "}span,svg{display:block}" + Tt);
  }
  ...
  !(function (t = "iconify-icon") {
    ...
    const r = ["icon", "mode", "inline", "noobserver", "width", "height", "rotate", "flip"],
      o = class extends n {
        ...
        _renderIcon(t, e, n) {
          ...
          Ht(
            this._shadowRoot,
            (this._state = { rendered: !0, icon: t, inline: r, customisations: e, attrMode: n, renderedMode: i })
          );
        }
        startObserver() {
    ...
    const s = (function () {
      ...
      return {
        ...
        _api: { getAPIConfig: U, setAPIModule: T, sendAPIQuery: B, setFetch: Ct, getFetch: It, listAPIProviders: H },
      };
    })();
