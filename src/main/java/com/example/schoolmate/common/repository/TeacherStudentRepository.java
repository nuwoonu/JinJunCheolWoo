...
public interface TeacherStudentRepository extends JpaRepository<TeacherStudent, Long> {
     ...
     */
    List<TeacherStudent> findByTeacherInfoIdAndSchoolYearAndRole(Long teacherInfoId, int schoolYear, TeacherRole role);
     ...
     */
    Optional<TeacherStudent> findByStudentInfoIdAndSchoolYearAndRole(Long studentInfoId, int schoolYear, TeacherRole role);
